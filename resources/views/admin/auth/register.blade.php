                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="mt-4">
                                            <form id="loginForm">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="position-relative auth-pass-inputgroup">
                                                        <input type="password" class="form-control pe-5 password-input"  placeholder="Enter password" id="confirm_password" name="confirm_password" required>
                                                        <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" id="password-addon"><i class="ri-eye-fill align-middle"></i></button>
                                                        <div class="invalid-feedback">
                                                            Confirm Password
                                                        </div>
                                                ...
                                                <div class="mt-4">
                                                    <button class="btn btn-primary w-100" type="submit" id="loginForm_submit">Sign up</button>
                                                </div>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0">Don't have an account ? <a href="{{ route('signin') }}" class="fw-semibold text-primary text-decoration-underline"> Signin</a> </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
