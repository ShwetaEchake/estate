...
Route::middleware(['auth','PreventBackHistory'])->group(function()
{
    ...
    Route::put('application-for-rents/{application_for_rent}/change-request', [App\Http\Controllers\Admin\ApplicationForRentController::class, 'changeRequest'] )->name('application-for-rents.change-request');
