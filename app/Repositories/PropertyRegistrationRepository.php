...
class PropertyRegistrationRepository
{
    ...
    public function showProperty($PropertyRegistration)
    {

        $PropertyRegistration->load('zone','source');

        $html = '
                <div class="row">
                    <div class="col-4 mt-2"> <strong> Zone : </strong> </div>
                    <div class="col-8 mt-2"> '.$PropertyRegistration->zone->name.' </div>
                   
                    <div class="col-4 mt-2"> <strong> Property No : </strong> </div>
                    <div class="col-8 mt-2"> '.$PropertyRegistration->property_no.' </div>

                    <div class="col-4 mt-2"> <strong> Old Property No : </strong> </div>
                    <div class="col-8 mt-2"> '.$PropertyRegistration->old_property_no.' </div>

                    <div class="col-4 mt-2"> <strong> Property Name : </strong> </div>
                    <div class="col-8 mt-2"> '.$PropertyRegistration->property_name.' </div>

                    <div class="col-4 mt-2"> <strong> Property Address : </strong> </div>
                    <div class="col-8 mt-2"> '.$PropertyRegistration->property_address.' </div>

                    <div class="col-4 mt-2"> <strong> Mauja : </strong> </div>
                    <div class="col-8 mt-2"> '.$PropertyRegistration->mauja.' </div>

                    <div class="col-4 mt-2"> <strong> Sheet No : </strong> </div>
                    <div class="col-8 mt-2"> '.$PropertyRegistration->sheet_no.' </div>

                    <div class="col-4 mt-2"> <strong> Plot No : </strong> </div>
                    <div class="col-8 mt-2"> '.$PropertyRegistration->plot_no.' </div>

                    <div class="col-4 mt-2"> <strong> Area : </strong> </div>
                    <div class="col-8 mt-2"> '.$PropertyRegistration->area.' </div>

                    <div class="col-4 mt-2"> <strong> Reckoner rate : </strong> </div>
                    <div class="col-8 mt-2"> '.$PropertyRegistration->ready_reckoner_rate.' </div>

                    <div class="col-4 mt-2"> <strong> Valuation : </strong> </div>
                    <div class="col-8 mt-2"> '.$PropertyRegistration->valuation.' </div>

                    <div class="col-4 mt-2"> <strong> Source : </strong> </div>
                    <div class="col-8 mt-2"> '.$PropertyRegistration->source->name.' </div>

                    <div class="col-4 mt-2"> <strong> Date of acquisition : </strong> </div>
                    <div class="col-8 mt-2"> '. Carbon::parse($PropertyRegistration->date_of_acquisition)->format('d-m-Y') .' </div>

                    <div class="col-4 mt-2"> <strong> Development status : </strong> </div>
                    <div class="col-8 mt-2"> '.($PropertyRegistration->development_status == "developed" ? "developed" : "undeveloped").' </div>

                    <div class="col-4 mt-2"> <strong> Remark : </strong> </div>
                    <div class="col-8 mt-2"> '.$PropertyRegistration->remark.' </div>

                    <div class="col-4 mt-2"> <strong> Latitude : </strong> </div>
                    <div class="col-8 mt-2"> '.$PropertyRegistration->latitude.' </div>

                    <div class="col-4 mt-2"> <strong> Longitude : </strong> </div>
                    <div class="col-8 mt-2"> '.$PropertyRegistration->longitude.' </div>
